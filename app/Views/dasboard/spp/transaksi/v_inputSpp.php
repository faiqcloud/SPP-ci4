...
<div class="container my-4">
    <div class="row">
        <div class="col">
            <div class="card">
                <h5 class="card-header" style="background-color:rgb(31, 143, 196); color: white;">Input Data SPP</h5>
                <div class="card-body">
                    <p class="card-text">
                    <form action="<?= base_url('spp/input'); ?>" method="post">
                        <div class="mb-3">
                            <label for="kspp" class="form-label">Kode Pembayaran</label>
                            <input type="text" class="form-control" id="kspp" name="kspp" placeholder="periode">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="bspp" class="form-label">Pembayaran</label>
                            <input type="text" class="form-control" id="bspp" name="bspp" placeholder="periode">
                        </div>
